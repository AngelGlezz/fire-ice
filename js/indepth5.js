	...
	$("#indepth_boton_empezar").click(false);
	 ...
	 var data = {
				  "preguntas": [
				    ...
				    {
				      "pregunta": '<img src="' + urlIndepth + 'images/preguntas/p9.png">',
				      "respuestas": [
				        {
				    ...
				    {
				      "pregunta": '<img src="' + urlIndepth + 'images/preguntas/p10.png">',
				      "respuestas": [
				        {
		...
		if (ancho >= 768) {
			$(".red").mouseenter(function(){
				...
				$(this).children().attr("src", urlIndepth + "images/preguntas/red"+(ele+1)+".jpg").css({"box-shadow": "1px 2px 15px 10px #C63031"});
				...
				var ele = parseInt($(this).attr("ele"));
				$(this).children().attr("src", urlIndepth + "images/preguntas/fire"+(ele+1)+".jpg").css({"box-shadow": "none"});
				var bottom = $(this).next().next().children()[0];
			...
			$(".hot").mouseenter(function(){
				...
				$(parent).children().attr("src", urlIndepth + "images/preguntas/red"+(ele+1)+".jpg").css({"box-shadow": "1px 2px 15px 10px #C63031"});
				...
				var parent = $(this).parent().parent().children()[0];
				var ele = parseInt($(parent).attr("ele"));
				$(parent).children().attr("src", urlIndepth + "images/preguntas/fire"+(ele+1)+".jpg").css({"box-shadow": "none"});
			...
			$(".blue").mouseenter(function(){
				var ele = parseInt($(this).attr("ele"));
				$(this).children().attr("src", urlIndepth + "images/preguntas/blue"+(ele+1)+".jpg").css({"box-shadow": "1px 2px 15px 10px #2db2de"});
				var bottom = $(this).next().children()[1];
				$(bottom).css({"background-color": "#2db2de", "box-shadow": "1px 2px 15px 10px #2db2de", "z-index" : "100"});	
				$(this).css({"position":"relative"});
			}).mouseleave(function(){
				var ele = parseInt($(this).attr("ele"));
				$(this).children().attr("src", urlIndepth + "images/preguntas/ice"+(ele+1)+".jpg").css({"box-shadow": "none"});
				var bottom = $(this).next().children()[1];
				$(bottom).css({"background-color": "#464646", "box-shadow": "none", "z-index" : "1"});
				$(this).css({"position":"inherit"});		
			});
			...
			$(".ice").mouseenter(function(){
				...
				var ele = parseInt($(parent).attr("ele"));
				$(parent).children().attr("src", urlIndepth + "images/preguntas/blue"+(ele+1)+".jpg").css({"box-shadow": "1px 2px 15px 10px #2db2de"});
				$(parent).css({"position":"relative"});
				$(this).css({"background-color": "#2db2de", "box-shadow": "1px 2px 15px 10px #2db2de", "z-index" : "100"});	
			}).mouseleave(function(){
				var parent = $(this).parent().parent().children()[1];
				var ele = parseInt($(parent).attr("ele"));
				$(parent).children().attr("src", urlIndepth + "images/preguntas/ice"+(ele+1)+".jpg").css({"box-shadow": "none"});
				$(parent).css({"position":"inherit"});
				$(this).css({"background-color": "#464646", "box-shadow": "none", "z-index" : "1"});			
			});
		} else {
			$(".red img").each(function(index) {
			  	$(this).attr("src", urlIndepth + "images/preguntas/red"+(index+1)+".jpg");
				//$(".blue img").attr("src", urlIndepth + "images/preguntas/blue"+(index+1)+".jpg");
			});

			$(".blue img").each(function(index) {
				$(this).attr("src", urlIndepth + "images/preguntas/blue"+(index+1)+".jpg");
			});
		...
		$(document).on("click",".red",function(){
				...
				var pregunta_num = respuesta_cont.attr("num");
				var respuesta_num = $("div.hot").attr("num");
				var pregunta_obj = preguntas[pregunta_num];
				var respuesta_obj = pregunta_obj.respuestas[respuesta_num];
		...
		$(document).on("click",".blue",function(){
				...
				var pregunta_num = respuesta_cont.attr("num");
				var respuesta_num = $("div.ice").attr("num");
				var pregunta_obj = preguntas[pregunta_num];
				var respuesta_obj = pregunta_obj.respuestas[respuesta_num];
